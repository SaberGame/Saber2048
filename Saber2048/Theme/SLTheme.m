...
#pragma mark --- SLDefaultTheme

@interface SLDefaultTheme : NSObject <SLThemeProx>
@end

@implementation SLDefaultTheme
...
#pragma mark --- SLVibrantTheme

@interface SLVibrantTheme : NSObject <SLThemeProx>
@end

@implementation SLVibrantTheme
...
@interface SLJoyfulTheme : NSObject <SLThemeProx>
@end

@implementation SLJoyfulTheme
...
@implementation SLTheme

+ (Class)themeClassForType:(NSInteger)type {
    switch (type) {
        case 1:
            return [SLVibrantTheme class];
        case 2:
            return [SLJoyfulTheme class];
        default:
            return [SLDefaultTheme class];
    }
}
